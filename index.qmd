...
The main focus of *machine learning* (ML)^[Machine Learning] is *making decisions or predictions based on data*. There are a number of other fields with significant overlap in technique, but differences in focus.
